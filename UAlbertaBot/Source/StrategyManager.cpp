...
StrategyManager::StrategyManager()
	: m_selfRace(BWAPI::Broodwar->self()->getRace()), m_enemyRace(BWAPI::Broodwar->enemy()->getRace()), m_emptyBuildOrder(BWAPI::Broodwar->self()->getRace())
{
}
...
const bool StrategyManager::shouldExpandNow() const
{
	...
	size_t numDepots = UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Terran_Command_Center) + UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Protoss_Nexus) + UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Zerg_Hatchery) + UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Zerg_Lair) + UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Zerg_Hive);
...
const MetaPairVector StrategyManager::getTerranBuildOrderGoal() const
{
	...
	int numTanks = UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Terran_Siege_Tank_Tank_Mode) + UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Terran_Siege_Tank_Siege_Mode);
...
const MetaPairVector StrategyManager::getZergBuildOrderGoal() const
{
	...
	int numCC = UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Zerg_Hatchery) + UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Zerg_Lair) + UnitUtil::GetAllUnitCount(BWAPI::UnitTypes::Zerg_Hive);
