...
MetaType::MetaType(BWAPI::UnitType t)
	: m_unitType(t), m_type(MetaTypes::Unit), m_race(t.getRace())
{
}

MetaType::MetaType(BWAPI::TechType t)
	: m_techType(t), m_type(MetaTypes::Tech), m_race(t.getRace())
{
}

MetaType::MetaType(BWAPI::UpgradeType t)
	: m_upgradeType(t), m_type(MetaTypes::Upgrade), m_race(t.getRace())
{
}
